...
type Goal = {
  ...
  soldierAssessment: string | null; raterAssessment: string | null; _count: { linkedEntries: number };
};
...
type GoalAction = "REVIEW" | "SELF_ASSESSMENT" | "RATER_ASSESSMENT" | "COUNSELING" | "EVIDENCE" | "CARRY_FORWARD";
...
export default function SupportFormGoalsPage() {
  ...
  async function createGoal(event: React.FormEvent) {
    ...
    try {
      await api.post(`/support-forms/${formId}/goals`, { sectionKey, title: title.trim(), description: description.trim() });
